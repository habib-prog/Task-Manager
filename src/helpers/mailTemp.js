  ...
  return `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden;">
        ...
        <div style="padding: 30px; background-color: #ffffff; text-align: center;">
          <h2 style="color: #333333;">${otp ? "Verify Your Email" : "Registration Successful!"}</h2>
          
          <p style="color: #666666; font-size: 16px;">
            ${msg || "Welcome! Use the OTP code below to complete your registration."}
          </p>
          ...
          <p style="color: #999999; font-size: 12px;">This code is valid for 10 minutes.</p>
          `
              : `
          <div style="margin: 30px 0;">
            <div style="font-size: 50px;">✅</div>
            <p style="color: #4A90E2; font-weight: bold;">Your account is now fully verified.</p>
          </div>
          `
          }
